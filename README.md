...
一個部署在 Zeabur 上、使用 Anthropic Claude 打造的 LINE AI 秘書助手。
溫柔體貼、聰明能幹，做大老闆最得力的後盾。
...
| 功能 | 說明 |
|------|------|
| 💬 **智慧聊天** | 貼心秘書般的溫暖對話，記住你說過的事 |
| 🖼 **圖片分析** | 傳圖片給 Lumio，自動辨識分析內容 |
| 📋 **長文摘要** | 貼上文章、報告、會議紀錄，秒抓重點 |
| 📧 **郵件起草** | 描述需求，自動生成專業商務郵件 |
| 🤔 **決策分析** | 列出選項，幫你分析優缺點與風險 |
| 📝 **待辦事項** | 新增、完成、刪除，PostgreSQL 持久化不遺失 |
| 🌤 **天氣查詢** | 即時查詢全球天氣 |
| 🌐 **即時翻譯** | 中英文自動互譯 |
| 💪 **加油打氣** | 隨時給你溫暖的鼓勵 |
...
| 時間 | 主題 | 內容 |
|------|------|------|
| 08:00 | ☀️ 早安問候 | 溫馨問候 + 今日正能量，開啟美好一天 |
| 12:00 | 🍱 午餐提醒 | 關心有沒有吃飯 + 飲食健康小建議 |
| 16:00 | ☕ 下午打氣 | 關心工作狀況 + 提醒休息補充能量 |
| 23:00 | 🌙 晚安提醒 | 肯定今天辛勞 + 溫柔催睡 |

> 需設定 `LINE_GROUP_ID` 環境變數才會啟用推播

### 對話記憶

- 使用 PostgreSQL 持久化儲存，重啟部署也不會遺失
